...
export const GET_PRODUCTS_BEGIN = 'GET_PRODUCTS_BEGIN' //for loading spinner
export const GET_PRODUCTS_SUCCESS = 'GET_PRODUCTS_SUCCESS'//close loading spinner
export const GET_PRODUCTS_ERROR = 'GET_PRODUCTS_ERROR'//err
